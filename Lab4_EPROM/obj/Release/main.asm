...
; This file generated Sun Nov 13 18:34:39 2016
;--------------------------------------------------------
	.module main
...
;	main.c:38: bool DisableFlag = false;
;	genAssign
	clr	_DisableFlag
	.area GSFINAL (CODE)
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:54: _sdcc_external_startup(){
;	-----------------------------------------
...
__sdcc_external_startup:
	...
	ar0 = 0x00
	ar1 = 0x01
;	main.c:56: AUXR |= AUXR_ENABLE_XRAM_MASK;   //Enable all XRAM
;	genOr
	orl	_AUXR,#0x0C
;	main.c:57: return 0;
;	genRet
...
;------------------------------------------------------------
;	main.c:61: void getBlockAndAddress(uint8_t *address, uint8_t *block){
;	-----------------------------------------
...
;	genCall
	...
	pop	ar3
	pop	ar2
;	main.c:66: *block = Serial_GetInteger(1);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0001
	push	ar2
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:70: *address = Serial_GetHex();
;	genAssign
	mov	dptr,#_getBlockAndAddress_address_1_1
	movx	a,@dptr
	mov	r2,a
...
;------------------------------------------------------------
;	main.c:84: void handlePCFMode(char c){
;	-----------------------------------------
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:89: pin = Serial_GetInteger(1);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0001
	lcall	_Serial_GetInteger
...
;	Peephole 251.a	replaced ljmp to ret with ret
	ret
00103$:
;	main.c:94: PCF_SetOutputLow(pin);
;	genCall
	mov	dpl,r2
;	main.c:95: break;
;	Peephole 251.a	replaced ljmp to ret with ret
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:98: pin = Serial_GetInteger(1);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0001
	lcall	_Serial_GetInteger
;	genCast
;	main.c:99: PCF_SetInputOutput(pin);
;	genCall
	mov	r2,dpl
	mov	r3,dph
...
;	genAssign
	clr	_EA
;	main.c:106: printf("/r/nCounter reset\r\n");
;	genIpush
	mov	a,#__str_12
	push	acc
	mov	a,#(__str_12 >> 8)
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:107: ButtonCount = 0;
;	genAssign
	mov	dptr,#_ButtonCount
;	Peephole 181	changed mov to clr
;	main.c:108: LCD_gotoxy(3,0);
;	genAssign
;	Peephole 181	changed mov to clr
...
;	genCall
	mov	dpl,#0x03
	lcall	_LCD_gotoxy
;	main.c:109: LCD_Putch(ButtonCount + 0x30);  //Output decimal value
;	genAssign
	mov	dptr,#_ButtonCount
	movx	a,@dptr
;	genPlus
...
;	Peephole 244.c	loading dpl from a instead of r2
	mov	dpl,a
	lcall	_LCD_Putch
;	main.c:110: PCF_OutputCount(ButtonCount);
;	genAssign
	mov	dptr,#_ButtonCount
	movx	a,@dptr
;	genCall
...
;------------------------------------------------------------
;	main.c:138: void handleCGMode(char c){
;	-----------------------------------------
...
;	main.c:141: case 'T':
00101$:
;	main.c:142: TestWrite();
;	genCall
	lcall	_TestWrite
;	main.c:143: LCD_gotoxy(0,3);
;	genAssign
	mov	dptr,#_LCD_gotoxy_PARM_2
	mov	a,#0x03
	movx	@dptr,a
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:151: addr = Serial_GetInteger(2);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0002
	lcall	_Serial_GetInteger
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:154: addr = Serial_GetInteger(2);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0002
	lcall	_Serial_GetInteger
...
;------------------------------------------------------------
;	main.c:191: void handleLCDMode(char c){
;	-----------------------------------------
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:206: address = Serial_GetHex();
;	genCall
	lcall	_Serial_GetHex
;	main.c:207: LCD_gotoaddr(address);
;	genCall
	mov  r2,dpl
;	Peephole 177.a	removed redundant mov
;	main.c:208: break;
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:211: row = Serial_GetInteger(3);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0003
	lcall	_Serial_GetInteger
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:214: row = Serial_GetInteger(3);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0003
	lcall	_Serial_GetInteger
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:218: col = Serial_GetInteger(3) ;
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0003
	lcall	_Serial_GetInteger
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:221: col = Serial_GetInteger(3);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0003
	lcall	_Serial_GetInteger
...
;	Peephole 177.a	removed redundant mov
	lcall	_LCD_Putch
;	main.c:231: address = LCD_ReadAddr();
;	genCall
	lcall	_LCD_ReadAddr
	mov	r2,dpl
;	main.c:232: TimerRedraw();
;	genCall
	push	ar2
	lcall	_TimerRedraw
	pop	ar2
;	main.c:233: LCD_gotoaddr(address);
;	genCall
	mov	dpl,r2
;	main.c:235: break;
;	Peephole 251.a	replaced ljmp to ret with ret
...
;	main.c:236: case 's':
00111$:
;	main.c:237: printf("\r\Enter a string\r\n");
;	genIpush
	mov	a,#__str_34
	push	acc
	mov	a,#(__str_34 >> 8)
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00114$
00116$:
;	main.c:248: LCD_Putstr(str);
;	genCall
;	Peephole 182.a	used 16 bit load of DPTR
	mov	dptr,#_handleLCDMode_str_1_1
	mov	b,#0x00
	lcall	_LCD_Putstr
;	main.c:249: address = LCD_ReadAddr();
;	genCall
	lcall	_LCD_ReadAddr
	mov	r2,dpl
;	main.c:250: TimerRedraw();
;	genCall
	push	ar2
	lcall	_TimerRedraw
	pop	ar2
;	main.c:251: LCD_gotoaddr(address);
;	genCall
	mov	dpl,r2
;	main.c:252: break;
;	Peephole 251.a	replaced ljmp to ret with ret
...
;	main.c:253: case 'C':
00117$:
;	main.c:254: LCD_ClearScreen();
;	genCall
	lcall	_LCD_ClearScreen
;	main.c:255: TimerRedraw();
;	genCall
	lcall	_TimerRedraw
;	main.c:256: LCD_gotoxy(0,0);    //Start at 0,0
;	genAssign
	mov	dptr,#_LCD_gotoxy_PARM_2
;	Peephole 181	changed mov to clr
	clr	a
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:263: printf("%x: ", start_addr);
;	genIpush
	mov	a,#0x80
	push	acc
;	Peephole 181	changed mov to clr
...
;	genAssign
	mov	r4,#0x10
00129$:
;	main.c:265: LCD_SetDDRAMAddress(start_addr);
;	genCast
	mov	ar5,r2
;	genCall
	mov	dpl,r5
	...
	pop	ar3
	pop	ar2
;	main.c:266: lcdData = LCD_ReadRAM();
;	genCall
	push	ar2
	push	ar3
	push	ar4
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:273: printf("%x: ", start_addr);
;	genIpush
	mov	a,#0xC0
	push	acc
;	Peephole 181	changed mov to clr
...
;	genAssign
	mov	r4,#0x10
00132$:
;	main.c:275: LCD_SetDDRAMAddress(start_addr);
;	genCast
	mov	ar5,r2
;	genCall
	mov	dpl,r5
	...
	pop	ar3
	pop	ar2
;	main.c:276: lcdData = LCD_ReadRAM();
;	genCall
	push	ar2
	push	ar3
	push	ar4
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:283: printf("%x: ", start_addr);
;	genIpush
	mov	a,#0x90
	push	acc
;	Peephole 181	changed mov to clr
...
;	genAssign
	mov	r4,#0x10
00135$:
;	main.c:285: LCD_SetDDRAMAddress(start_addr);
;	genCast
	mov	ar5,r2
;	genCall
	mov	dpl,r5
	...
	pop	ar3
	pop	ar2
;	main.c:286: lcdData = LCD_ReadRAM();
;	genCall
	push	ar2
	push	ar3
	push	ar4
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:293: printf("%x: ", start_addr);
;	genIpush
	mov	a,#0xD0
	push	acc
;	Peephole 181	changed mov to clr
...
;	genAssign
	mov	r4,#0x10
00138$:
;	main.c:295: LCD_SetDDRAMAddress(start_addr);
;	genCast
	mov	ar5,r2
;	genCall
	mov	dpl,r5
	...
	pop	ar3
	pop	ar2
;	main.c:296: lcdData = LCD_ReadRAM();
;	genCall
	push	ar2
	push	ar3
	push	ar4
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:307: EA = 0;     //Disable interrupts temporarily. Shared globals
;	genAssign
	clr	_EA
;	main.c:308: Saved_Address = LCD_ReadAddr();
;	genCall
	lcall	_LCD_ReadAddr
	mov	a,dpl
;	genAssign
	...
	movx	@dptr,a
;	main.c:309: CG_Accessed = true;
;	genAssign
	setb	_CG_Accessed
;	main.c:310: EA = 1;
;	genAssign
	setb	_EA
;	main.c:313: start_addr = 0x40;
;	genAssign
	...
	inc	dptr
	movx	@dptr,a
;	main.c:315: while (start_addr < 0x80){
00120$:
;	genAssign
	mov	dptr,#_handleLCDMode_start_addr_1_1
	movx	a,@dptr
...
;	genIfxJump
	...
	ljmp	00122$
00206$:
;	main.c:316: printf("%x: ", start_addr);
;	genIpush
	push	ar2
	push	ar3
	push	ar2
...
;	genAssign
	mov	r4,#0x10
00141$:
;	main.c:319: LCD_SetCGRAMAddress(start_addr);
;	genCast
	mov	ar5,r2
;	genCall
	mov	dpl,r5
	...
	pop	ar3
	pop	ar2
;	main.c:320: lcdData = LCD_ReadRAM();
;	genCall
	push	ar2
	push	ar3
	push	ar4
...
;	genCall
	...
	ljmp	00120$
00122$:
;	main.c:327: LCD_SetDDRAMAddress(Saved_Address);
;	genAssign
	mov	dptr,#_Saved_Address
	movx	a,@dptr
;	genCall
...
;	genAssign
	clr	_EA
;	main.c:329: CG_Accessed = false;
;	genAssign
	clr	_CG_Accessed
;	main.c:330: EA = 1;
;	genAssign
	setb	_EA
;	main.c:331: TimerRedraw();
;	genCall
;	main.c:332: break;
;	main.c:333: case 'r':
;	Peephole 112.b	changed ljmp to sjmp
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:345: void EEPROM_Menu(void){
;	-----------------------------------------
...
;------------------------------------------------------------
;	main.c:355: void handleEEPROMMode(char c){
;	-----------------------------------------
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:368: getBlockAndAddress(&address, &block);
;	genCast
	mov	dptr,#_getBlockAndAddress_PARM_2
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:370: lcdData = Serial_GetHex();
;	genCall
	lcall	_Serial_GetHex
	mov	r2,dpl
;	main.c:371: EPROM_ByteWrite(lcdData, address, block);
;	genAssign
	mov	dptr,#_handleEEPROMMode_address_1_1
	movx	a,@dptr
	mov	r3,a
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:376: getBlockAndAddress(&address, &block);
;	genCast
	mov	dptr,#_getBlockAndAddress_PARM_2
	mov	a,#_handleEEPROMMode_block_1_1
	movx	@dptr,a
...
;	Peephole 182.a	used 16 bit load of DPTR
	...
	mov	b,#0x00
	lcall	_getBlockAndAddress
;	main.c:378: lcdData = EPROM_ByteRead(address, block);
;	genAssign
	mov	dptr,#_handleEEPROMMode_address_1_1
	movx	a,@dptr
	mov	r2,a
...
;	main.c:381: case 'L':
00103$:
;	main.c:382: getBlockAndAddress(&address, &block);
;	genCast
	mov	dptr,#_getBlockAndAddress_PARM_2
	mov	a,#_handleEEPROMMode_block_1_1
	movx	@dptr,a
...
;	Peephole 182.a	used 16 bit load of DPTR
	...
	mov	b,#0x00
	lcall	_getBlockAndAddress
;	main.c:384: lcdData = EPROM_ByteRead(address, block);
;	genAssign
	mov	dptr,#_handleEEPROMMode_address_1_1
	movx	a,@dptr
	mov	r2,a
...
;	genCall
	...
	dec	sp
	pop	ar2
;	main.c:387: Lcd_row = Serial_GetInteger(1);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0001
	push	ar2
	...
	pop	ar2
;	genCast
;	main.c:389: LCD_gotoxy(Lcd_row, 0);
;	genAssign
	mov	dptr,#_LCD_gotoxy_PARM_2
;	Peephole 181	changed mov to clr
	clr	a
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:401: getBlockAndAddress(&address, &block);
;	genCast
	mov	dptr,#_getBlockAndAddress_PARM_2
	mov	a,#_handleEEPROMMode_block_1_1
	movx	@dptr,a
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:403: getBlockAndAddress(&end_address, &end_block);
;	genCast
	mov	dptr,#_getBlockAndAddress_PARM_2
...
;	Peephole 182.a	used 16 bit load of DPTR
	...
	mov	b,#0x00
	lcall	_getBlockAndAddress
;	main.c:404: start_addr =( block << 8) | address;
;	genAssign
	mov	dptr,#_handleEEPROMMode_block_1_1
	movx	a,@dptr
	mov	r2,a
...
;	genAssign
	...
	mov	a,r3
	movx	@dptr,a
;	main.c:405: end_addr = (end_block << 8) | end_address;
;	genAssign
...
;	genAssign
	...
	mov	a,r5
	movx	@dptr,a
;	main.c:406: if (start_addr > end_addr){
;	genAssign
;	genAssign
;	genCmpGt
;	genCmp
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:411: while(start_addr <= end_addr){
;	genAssign
	mov	dptr,#_handleEEPROMMode_end_addr_1_1
	movx	a,@dptr
	mov	r2,a
...
;	Peephole 251.a	replaced ljmp to ret with ret
	ret
00142$:
;	main.c:412: printf("%x: ", start_addr);
;	genIpush
	push	ar2
	push	ar3
	push	ar4
...
;	main.c:415: lcdData = EPROM_ByteRead(start_addr & 0xFF, start_addr >> 8);
;	genIpush
	push	ar4
	push	ar5
;	genAnd
...
;     genPlusIncr
	...
	inc	r7
00145$:
;	main.c:418: if(start_addr > end_addr){
;	genCmpGt
;	genCmp
	clr	c
	mov	a,r2
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:439: void CLOCK_Menu(void){
;	-----------------------------------------
;	 function CLOCK_Menu
;	-----------------------------------------
_CLOCK_Menu:
...
;------------------------------------------------------------
;	main.c:453: void handleCLOCKMode(char c){
;	-----------------------------------------
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:471: alarm_duration = Serial_GetInteger(5);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0005
	lcall	_Serial_GetInteger
;	main.c:472: Clock_NewAlarm(alarm_duration);
;	genCall
	mov	r2,dpl
;	Peephole 177.d	removed redundant move
	mov  r3,dph
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:485: i = Serial_GetInteger(1);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0001
	lcall	_Serial_GetInteger
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:488: i = Serial_GetInteger(1);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0001
	lcall	_Serial_GetInteger
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:495: i = Serial_GetInteger(1);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0001
	lcall	_Serial_GetInteger
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:498: i = Serial_GetInteger(1);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0001
	lcall	_Serial_GetInteger
...
;------------------------------------------------------------
;	main.c:529: void handleMAINMode(char c){
;	-----------------------------------------
...
;	Peephole 253.a	replaced lcall/ret with ljmp
	ljmp	_LCD_Menu
00103$:
;	main.c:539: mode = EEPROM_MODE;
;	genAssign
	mov	dptr,#_mode
	mov	a,#0x02
	movx	@dptr,a
;	main.c:540: EEPROM_Menu();
;	genCall
;	main.c:541: break;
;	main.c:542: case 'C':
;	Peephole 112.b	changed ljmp to sjmp
...
;	Peephole 253.a	replaced lcall/ret with ljmp
	ljmp	_EEPROM_Menu
00104$:
;	main.c:543: mode = CLOCK_MODE;
;	genAssign
	mov	dptr,#_mode
	mov	a,#0x03
	movx	@dptr,a
;	main.c:544: CLOCK_Menu();
;	genCall
;	main.c:545: break;
;	main.c:546: case 'G':
;	Peephole 112.b	changed ljmp to sjmp
...
;------------------------------------------------------------
;	main.c:562: void handleInput(char c){
;	-----------------------------------------
...
00112$:
	...
	ljmp	00105$
	ljmp	00106$
;	main.c:564: case MAIN_MODE:
00101$:
;	main.c:565: handleMAINMode(c);
;	genAssign
	mov	dptr,#_handleInput_c_1_1
	movx	a,@dptr
;	genCall
...
;	Peephole 244.c	loading dpl from a instead of r2
	mov	dpl,a
;	main.c:566: break;
;	main.c:567: case LCD_MODE:
;	Peephole 112.b	changed ljmp to sjmp
;	Peephole 251.b	replaced sjmp to ret with ret
;	Peephole 253.a	replaced lcall/ret with ljmp
	ljmp	_handleMAINMode
00102$:
;	main.c:568: handleLCDMode(c);
;	genAssign
	mov	dptr,#_handleInput_c_1_1
	movx	a,@dptr
;	genCall
...
;	Peephole 244.c	loading dpl from a instead of r2
	mov	dpl,a
;	main.c:569: break;
;	main.c:570: case EEPROM_MODE:
;	Peephole 112.b	changed ljmp to sjmp
;	Peephole 251.b	replaced sjmp to ret with ret
;	Peephole 253.a	replaced lcall/ret with ljmp
	ljmp	_handleLCDMode
00103$:
;	main.c:571: handleEEPROMMode(c);
;	genAssign
	mov	dptr,#_handleInput_c_1_1
	movx	a,@dptr
;	genCall
...
;	Peephole 244.c	loading dpl from a instead of r2
	mov	dpl,a
;	main.c:572: break;
;	main.c:573: case CLOCK_MODE:
;	Peephole 112.b	changed ljmp to sjmp
;	Peephole 251.b	replaced sjmp to ret with ret
;	Peephole 253.a	replaced lcall/ret with ljmp
	ljmp	_handleEEPROMMode
00104$:
;	main.c:574: handleCLOCKMode(c);
;	genAssign
	mov	dptr,#_handleInput_c_1_1
	movx	a,@dptr
;	genCall
...
;	Peephole 244.c	loading dpl from a instead of r2
	mov	dpl,a
;	main.c:575: break;
;	main.c:576: case CG_MODE:
;	Peephole 112.b	changed ljmp to sjmp
;	Peephole 251.b	replaced sjmp to ret with ret
;	Peephole 253.a	replaced lcall/ret with ljmp
	ljmp	_handleCLOCKMode
00105$:
;	main.c:577: handleCGMode(c);
;	genAssign
	mov	dptr,#_handleInput_c_1_1
	movx	a,@dptr
;	genCall
...
;	Peephole 244.c	loading dpl from a instead of r2
	mov	dpl,a
;	main.c:578: break;
;	main.c:579: case PCF_MODE:
;	Peephole 112.b	changed ljmp to sjmp
;	Peephole 251.b	replaced sjmp to ret with ret
;	Peephole 253.a	replaced lcall/ret with ljmp
	ljmp	_handleCGMode
00106$:
;	main.c:580: handlePCFMode(c);
;	genAssign
	mov	dptr,#_handleInput_c_1_1
	movx	a,@dptr
;	genCall
...
;------------------------------------------------------------
;	main.c:588: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
;	main.c:590: Serial_Init();
;	genCall
	lcall	_Serial_Init
;	main.c:591: EPROM_Init();
;	genCall
	lcall	_EPROM_Init
;	main.c:592: PCF_Init();
;	genCall
...
;	genAssign
	setb	_P1_3
;	main.c:596: Timer0_Init();
;	genCall
	lcall	_Timer0_Init
;	main.c:597: mode = MAIN_MODE;
;	genAssign
	mov	dptr,#_mode
;	Peephole 181	changed mov to clr
;	main.c:598: LCD_gotoxy(0,0);    //Start at 0,0
;	genAssign
;	Peephole 181	changed mov to clr
;	Peephole 219.a	removed redundant clear
	clr	a
...
;	genCall
	lcall	_MainMenu
;	main.c:604: checkAlarms:
00101$:
;	main.c:605: for (i = 0; i < 3; ++i){
;	genAssign
...
;	genCall
	mov	dpl,#0x00
	lcall	_LCD_gotoxy
;	main.c:609: LCD_Putstr("Disable Alarm!");
;	genCall
;	Peephole 182.a	used 16 bit load of DPTR
	mov	dptr,#__str_83
	mov	b,#0x80
	lcall	_LCD_Putstr
;	main.c:610: while(getchar() != 'D'){
;	genAssign
	mov	dptr,#_main_i_2_2
	movx	a,@dptr
	mov	r3,a
...
;	genCall
	...
	lcall	_LCD_gotoxy
	pop	ar3
;	main.c:613: LCD_Putstr("Disable Alarm!");
;	genCall
;	Peephole 182.a	used 16 bit load of DPTR
	mov	dptr,#__str_83
	mov	b,#0x80
...
;	genAssign
	...
	ljmp	00119$
00122$:
;	main.c:623: c = getchar ();
;	genCall
	lcall	_getchar
	mov	r2,dpl
;	main.c:624: if(DisableFlag){
;	genIfx
;	genIfxJump
;	main.c:625: DisableFlag = false;
;	genAssign
...
;     genPlusIncr
	inc	r3
;	main.c:639: goto checkAlarms;
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00123$
00113$:
;	main.c:643: if (c == ENTER_KEY){
;	genCmpEq
;	gencjneshort
;	Peephole 112.b	changed ljmp to sjmp
;	Peephole 198.b	optimized misc jump sequence
...
;	genCall
	...
	pop	ar2
00115$:
;	main.c:646: putchar(c);
;	genCall
	mov	dpl,r2
	push	ar2
	lcall	_putchar
	pop	ar2
;	main.c:647: handleInput(c);
;	genCall
	mov	dpl,r2
	lcall	_handleInput
	ljmp	00101$
