...
; This file generated Sat Nov 05 18:57:33 2016
;--------------------------------------------------------
	.module main
...
__sdcc_external_startup:
	...
	ar0 = 0x00
	ar1 = 0x01
;	main.c:16: AUXR |= AUXR_ENABLE_XRAM_MASK;   //Enable all XRAM
;	genOr
	orl	_AUXR,#0x0C
;	main.c:17: return 0;
;	genRet
...
;------------------------------------------------------------
;	main.c:39: void handleInput(char c){
;	-----------------------------------------
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:49: LCD_ClearScreen();
;	genCall
	lcall	_LCD_ClearScreen
;	main.c:50: LCD_gotoaddr(0x40);
;	genCall
	mov	dpl,#0x40
;	main.c:51: break;
;	Peephole 251.a	replaced ljmp to ret with ret
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:54: row = Serial_GetInteger(3) ;
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0003
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:57: row = Serial_GetInteger(3);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0003
	lcall	_Serial_GetInteger
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:61: col = Serial_GetInteger(3) ;
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0003
	lcall	_Serial_GetInteger
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:64: col = Serial_GetInteger(3);
;	genCall
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0003
	lcall	_Serial_GetInteger
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:72: LCD_ClearScreen();
;	genCall
	lcall	_LCD_ClearScreen
;	main.c:73: LCD_gotoaddr(0x00);
;	genCall
	mov	dpl,#0x00
	lcall	_LCD_gotoaddr
;	main.c:74: LCD_Putch('A');
;	genCall
	mov	dpl,#0x41
	lcall	_LCD_Putch
;	main.c:75: LCD_gotoaddr(0x40);
;	genCall
	mov	dpl,#0x40
	lcall	_LCD_gotoaddr
;	main.c:76: LCD_Putch('B');
;	genCall
	mov	dpl,#0x42
	lcall	_LCD_Putch
;	main.c:77: LCD_gotoaddr(0x10);
;	genCall
	mov	dpl,#0x10
	lcall	_LCD_gotoaddr
;	main.c:78: LCD_Putch('C');
;	genCall
	mov	dpl,#0x43
	lcall	_LCD_Putch
;	main.c:79: LCD_gotoaddr(0x50);
;	genCall
	mov	dpl,#0x50
	lcall	_LCD_gotoaddr
;	main.c:80: LCD_Putch('D');
;	genCall
	mov	dpl,#0x44
;	main.c:81: break;
;	main.c:82: case 's':
...
;	Peephole 253.a	replaced lcall/ret with ljmp
	ljmp	_LCD_Putch
00111$:
;	main.c:83: printf("\r\Writing a string to LCD\r\n");
;	genIpush
	mov	a,#__str_14
	push	acc
	mov	a,#(__str_14 >> 8)
...
;	genCall
	...
	dec	sp
	dec	sp
;	main.c:84: LCD_ClearScreen();
;	genCall
	lcall	_LCD_ClearScreen
;	main.c:85: LCD_Putstr("abcdefghijklnopqrstuvwxyz123456789abcdefghijklmnopqrstuvwxyz12345678987654321");
;	genCall
...
;	main.c:104: while(1){
00104$:
;	main.c:106: c = getchar ();
;	genCall
	lcall	_getchar
	mov	r2,dpl
;	main.c:107: if (c == ENTER_KEY){
;	genCmpEq
;	gencjneshort
;	Peephole 112.b	changed ljmp to sjmp
...
;	genCall
	...
	pop	ar2
00102$:
;	main.c:110: putchar(c);
;	genCall
	mov	dpl,r2
	push	ar2
	lcall	_putchar
	pop	ar2
;	main.c:111: handleInput(c);
;	genCall
	mov	dpl,r2
	lcall	_handleInput
;	Peephole 112.b	changed ljmp to sjmp
...
__str_9:
	.db 0x0D
	.db 0x0A
	.ascii "Moved cursor to start of line 2"
	.db 0x0D
	.db 0x0A
	.db 0x00
__str_10:
...
__str_13:
	.db 0x0D
	.db 0x0A
	.ascii "Updating first character of each line"
	.db 0x0D
	.db 0x0A
	.db 0x00
__str_14:
	.db 0x0D
	.ascii "Writing a string to LCD"
	.db 0x0D
	.db 0x0A
	.db 0x00
__str_15:
