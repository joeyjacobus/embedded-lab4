...
; This file generated Wed Nov 09 17:33:25 2016
;--------------------------------------------------------
	.module serial
...
;------------------------------------------------------------
;	serial.c:24: void putchar (char c){
;	-----------------------------------------
;	 function putchar
;	-----------------------------------------
_putchar:
...
;	serial.c:26: SBUF = c; // load serial port with transmit value
;	genAssign
	mov	dptr,#_putchar_c_1_1
	movx	a,@dptr
	mov	_SBUF,a
;	serial.c:27: TI = 0; // clear TI flag
;	genAssign
	clr	_TI
...
;------------------------------------------------------------
;------------------------------------------------------------
;	serial.c:30: char getchar (){
;	-----------------------------------------
;	 function getchar
;	-----------------------------------------
_getchar:
;	serial.c:32: while (RI == 0);
00101$:
;	genIfx
;	genIfxJump
;	Peephole 108.d	removed ljmp by inverse jump logic
;	serial.c:33: RI = 0; // clear RI flag
;	genAssign
;	Peephole 250.a	using atomic test and clear
	jbc	_RI,00108$
	sjmp	00101$
00108$:
;	serial.c:34: return SBUF; // return character from SBUF
;	genAssign
	mov	r2,_SBUF
;	genRet
	mov	dpl,r2
...
;------------------------------------------------------------
;	serial.c:43: int Serial_GetInteger(int max_length){
;	-----------------------------------------
...
;	serial.c:49: printf("Serial_getInteger(): Error. Max_Length too large.");
;	genIpush
	mov	a,#__str_0
	push	acc
	mov	a,#(__str_0 >> 8)
...
;	genCall
	...
	dec	sp
	dec	sp
;	serial.c:50: return -1;
;	genRet
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0xFFFF
;	Peephole 251.a	replaced ljmp to ret with ret
	ret
;	serial.c:53: while (index < max_length ){
00125$:
;	genAssign
00116$:
;	genAssign
...
;	genCall
	...
	pop	ar3
	pop	ar2
;	serial.c:56: if (c == ENTER_KEY)
;	genCmpEq
;	gencjneshort
	cjne	r6,#0x0D,00130$
	ljmp	00118$
00130$:
;	serial.c:58: else if (c == BACKSPACE_KEY)
;	genCmpEq
;	gencjneshort
...
;	genCall
	...
	ljmp	00116$
00118$:
;	serial.c:71: buf[index] = '\0';  //Null terminate the string
;	genAssign
	mov	dptr,#_Serial_GetInteger_index_1_1
	movx	a,@dptr
	mov	r2,a
...
;------------------------------------------------------------
;	serial.c:79: uint8_t Serial_GetHex(void){
;	-----------------------------------------
;	 function Serial_GetHex
;	-----------------------------------------
_Serial_GetHex:
;	serial.c:83: int index = 0;
;	genAssign
	...
	inc	dptr
	movx	@dptr,a
;	serial.c:85: char num =0;
;	genAssign
	mov	dptr,#_Serial_GetHex_num_1_1
;	Peephole 181	changed mov to clr
	clr	a
	movx	@dptr,a
;	serial.c:87: while (index < max_length ){
00123$:
;	genAssign
	mov	dptr,#_Serial_GetHex_index_1_1
	movx	a,@dptr
...
;	serial.c:99: break;
	ljmp	00125$
00121$:
;	serial.c:101: else if (c == BACKSPACE_KEY)
;	genCmpEq
;	gencjneshort
;	Peephole 112.b	changed ljmp to sjmp
;	Peephole 198.b	optimized misc jump sequence
...
;	genAssign
	...
	ljmp	00123$
00118$:
;	serial.c:103: else if ( isdigit(c) ){
;	genCall
	mov	dpl,r4
	push	ar2
	push	ar3
...
;	Peephole 236.b	used r3 instead of ar3
	...
	ljmp	00123$
00115$:
;	serial.c:107: else if ( isalpha(c) && ((c >= 'A'  && c <= 'F') || (c >= 'a' && c <= 'f') )){
;	genCall
	mov	dpl,r4
	push	ar4
	lcall	_isupper
...
00106$:
;	serial.c:108: buf[index] = toupper(c);
;	genAssign
	mov	dptr,#_Serial_GetHex_index_1_1
	movx	a,@dptr
	mov	r2,a
...
;	genCall
	...
	ljmp	00123$
00125$:
;	serial.c:116: result = 0;
;	genAssign
	mov	dptr,#_Serial_GetHex_result_1_1
;	Peephole 181	changed mov to clr
	clr	a
	movx	@dptr,a
;	serial.c:117: while (index < max_length ){
;	genAssign
	mov	r2,#0x00
	mov	r3,#0x00
00136$:
...
;	Peephole 236.a	used r4 instead of ar4
	...
	movx	@dptr,a
00135$:
;	serial.c:125: result += num << (4*(1-index));
;	genMinus
	mov	a,#0x01
	clr	c
...
;------------------------------------------------------------
;	serial.c:133: void getstring(unsigned char *buf, int length){
;	-----------------------------------------
;	 function getstring
;	-----------------------------------------
_getstring:
...
;	genAssign
	...
	mov	a,r2
	movx	@dptr,a
;	serial.c:137: putchar(c);
;	genCall
	mov	dpl,r2
	lcall	_putchar
;	serial.c:138: while(c != ENTER_KEY && offset < length){
;	genAssign
...
;------------------------------------------------------------
;------------------------------------------------------------
;	serial.c:153: void Serial_Init(void){
;	-----------------------------------------
;	 function Serial_Init
;	-----------------------------------------
_Serial_Init:
;	serial.c:154: SCON = SCON_SERIAL_INIT;    //Init serial port
;	genAssign
	mov	_SCON,#0x50
;	serial.c:155: TMOD = TIMER1_TMOD_VAL;     // 8 bit auto-reload mode 2
;	genAssign
	mov	_TMOD,#0x20
;	serial.c:156: TH1 = TIMER1_RELOAD_VAL;
;	genAssign
	mov	_TH1,#0xFD
;	serial.c:157: TL1 = TIMER1_RELOAD_VAL;  //Auto-Reload value for timer 1 baud-rate = 9600
;	genAssign
	mov	_TL1,#0xFD
;	serial.c:159: TR1 = 1;
;	genAssign
	setb	_TR1
;	serial.c:160: TI = 1; //Clear to start
;	genAssign
	setb	_TI
